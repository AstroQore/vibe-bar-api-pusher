...
PROVIDER_META: dict[str, dict] = {
    "claude":           {"id": "claude-cli",         "display_name": "Claude",        "subtitle": "Claude Code",      "icon": "C"},
    "codex":            {"id": "codex-cli",          "display_name": "Codex",         "subtitle": "OpenAI CodeX",     "icon": "Cx"},
    ...
    "tencentTokenPlan": {"id": "tencent-token-plan", "display_name": "Tencent",       "subtitle": "Token Plan",       "icon": "Tc"},
